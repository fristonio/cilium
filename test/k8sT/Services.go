	...
	Context("Checks service across nodes", func() {
		...
		SkipContextIf(func() bool {
			...
			BeforeAll(func() {
				...
				ciliumAddServiceOnNode(helpers.K8s1, 31082, net.JoinHostPort(k8s2IPv6, fmt.Sprintf("%d", data.Spec.Ports[0].NodePort)),
					httpBackends, "NodePort", "Cluster")
				...
				ciliumAddServiceOnNode(helpers.K8s1, 31071, net.JoinHostPort(k8s1IPv6, fmt.Sprintf("%d", data.Spec.Ports[1].NodePort)),
					httpBackends, "NodePort", "Cluster")
				ciliumAddServiceOnNode(helpers.K8s1, 31071, net.JoinHostPort(k8s2IPv6, fmt.Sprintf("%d", data.Spec.Ports[1].NodePort)),
					httpBackends, "NodePort", "Cluster")
			})
